...
(function() {
  ...
  // Long-range metal prices and CPI-U live in metal-history.js (shared with the Analyst Briefing)
  var METAL_SEP = window.METAL_HISTORY.SEP;
  var METAL_ANN = window.METAL_HISTORY.ANN;
  var CPI_SEP = window.METAL_HISTORY.CPI_SEP;
  var CPI_ANN = window.METAL_HISTORY.CPI_ANN;
  ...
  var METAL_DATA_THROUGH = window.METAL_HISTORY.DATA_THROUGH;
  var METAL_PARTIAL_SEP = window.METAL_HISTORY.PARTIAL_SEP;
