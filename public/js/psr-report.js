...
(function() {
  ...
  var METAL_NAMES = ['Gold', 'Silver', 'Platinum', 'Palladium', 'Copper'];
  ...
  function renderMetalPerformance(evt, forPrint) {
    ...
    html += 'Copper is the monthly LME grade A cathode cash price (World Bank Pink Sheet, $/lb). ';
    html += 'Real figures deflate each year by CPI-U (BLS): the September index, and the Oct&ndash;Sep mean. ';
    html += '&dagger; September ' + METAL_PARTIAL_SEP + ' is a part-month average (prices through ' + METAL_DATA_THROUGH + ', copper through 2026-09-15); ';
